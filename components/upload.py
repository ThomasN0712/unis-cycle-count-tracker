...
def render_upload_form():
    ...
    """
    st.title("Cycle Count Data Management")
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["Add New Data", "Edit Existing", "Import/Export", "Delete Records"])
    
    # Tab 1: Add new record in table format
    with tab1:
        ...
        with st.form("table_form"):
            # Create table headers (removed Customer and Cycle Date)
            cols = st.columns([2, 3, 2, 2, 3])
            headers = ["Item ID*", "Description", "System Count", "Actual Count", "Notes"]
            ...
            for i, row_data in enumerate(st.session_state.table_data):
                ...
                # System Count
                row_data["system_count"] = cols[2].text_input(
                    "System Count", 
                ...
                # Actual Count
                row_data["actual_count"] = cols[3].text_input(
                    "Actual Count", 
                ...
                # Notes
                row_data["notes"] = cols[4].text_input(
                    "Notes", 
